...
# We get probabilities using simple standardization. There are more technical approaches to do this. See for instance Shin (1993) and Strumbelj (2014).\end{lstlisting}
	\end{VF}
\end{tcolorbox}
...
# Bayes factor
BF <- exp(LogML - LogMLnew)\end{lstlisting}
	\end{VF}
\end{tcolorbox} 
