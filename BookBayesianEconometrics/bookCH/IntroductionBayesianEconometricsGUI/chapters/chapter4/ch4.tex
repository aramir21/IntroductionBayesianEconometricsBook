...
\begin{align*}
	\log(\text{Electricity}_i) & = \beta_1\text{price}_i + \beta_2\text{IndSocio1}_i + \beta_3\text{IndSocio2}_i + \beta_4\text{Altitude}_i \\
...
We want to check the results of the Bayes factor comparing the previous specification with other without considering the electricity price, and check what happens as $c_0$ increases.
