...
y <- c(2, 2, 1) 
# Historical records last five mathces: Liverpool wins (2), draws (2) and Manchester city wins (1)	
# Marginal likelihood
MarLik <- function(a0){
	n <- sum(y)
