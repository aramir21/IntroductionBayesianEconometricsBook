...
\]
which is the expected effect of treatment for individuals with observed characteristics $\mathbf{X}_i=\mathbf{x}$ and unobserved resistance to treatment $U_{Di}=u_D$ \cite{heckman2005structural}.
...
\section{Reverse/Simultaneous causality}\label{sec12_9}

\section{Bayesian exponential tilted empirical likelihood}\label{sec12_10}
...
\section{A general framework for updating belief distributions}\label{sec12_11}
Introduce \cite{bissiri2016general} as a generalization of \cite{chernozhukov2003mcmc}.


\section{Doubly robust Bayesian inferential framework}\label{sec12_12}
\cite{breunig2025double}

\section{Other approaches}\label{sec12_13}
