...
\textbf{Example: Bayesian inference for causal effects in ramdomized experiments with noncompliance: Effects of vitamin A supplements on children's survival}

This example is taken from \cite{imbens1997bayesian}. They perform Bayesian inference of causal effects in a completely randomized experiment with no compliance and no covariates.
