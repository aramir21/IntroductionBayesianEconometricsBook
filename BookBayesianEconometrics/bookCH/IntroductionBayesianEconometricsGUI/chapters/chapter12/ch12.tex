...
Therefore, alternative approaches such as \textit{regression adjustment}, \textit{inverse probability weighting}, and \textit{doubly robust} estimators are preferable, as they provide consistent estimators under conditional parallel trends and are well known in the Frequentist econometric framework \cite{roth2023whats}.\footnote{See \cite{breunig2025double} for a doubly robust Bayesian inferential framework for average treatment effects.}
