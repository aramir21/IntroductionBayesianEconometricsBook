...
\textit{Simulation-based algorithms} suffer from the \textit{curse of dimensionality} in the parameter space, while \textit{optimization-based approaches} typically require explicit evaluation of likelihood functions. To address cases where both challenges arise simultaneously, recent developments, referred to as \textit{hybrid methods}, combine these strategies with the \textit{pseudo-marginal} approach \cite{andrieu2009pseudoefficient, martin2024approximating}. 
