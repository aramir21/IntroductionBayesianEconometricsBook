...
Any spline function of order $n$ can be expressed as a linear combination of B-splines of order $n$. B-splines play the role of basis functions for the spline function space %(https://en.wikipedia.org/wiki/B-spline#Cubic\_B-Splines).
