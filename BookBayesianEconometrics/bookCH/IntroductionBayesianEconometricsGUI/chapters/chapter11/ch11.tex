...
We also can use this simulation to see the effect of changing the knots. The following code performs the fit using least squares, which is equivalent to use a non-informative prior under the Bayesian approach in the linear regression framework.
