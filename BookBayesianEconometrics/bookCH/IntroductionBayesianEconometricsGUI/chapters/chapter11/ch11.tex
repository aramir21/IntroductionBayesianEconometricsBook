...
We can also use DPM in a semi-parametric setting, as we did in the finite Gaussian mixtures. In Exercise 3 we ask to get the posterior sampler in this setting, that is,
\begin{align*}
