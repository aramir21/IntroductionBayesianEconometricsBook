...
This specification controls for age, a gender indicator (male equal to 1), years of schooling, an indicator of marital status (married equal to 1),  the logarithm of monthly gross income, and self perception of health status, good and bad. We also assume that the unobserved heterogeneity is associated with whether the individual receives welfare payments (Sozh equal to 1). 
