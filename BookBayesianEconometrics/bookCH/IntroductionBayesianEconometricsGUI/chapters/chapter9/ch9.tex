...
\begin{algorithm}[h!]
	...
	\begin{algorithmic}[1]  		 			
		...
		\State Download posterior chains and diagnostic plots using the \textit{Download Posterior Chains} and \textit{Download Posterior Graphs} buttons
	\end{algorithmic}
	$^*${\footnotesize{At the time of writing this book there was an issue with the function \textit{MCMChpoisson} from \textit{MCMCpack}. Thus, users may have issues running this algorithm or running this function directly in \textbf{R}.}} 
\end{algorithm}
