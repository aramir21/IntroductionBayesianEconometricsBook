...
This book is divided in three parts, foundations (chapters 1 to 5), regression analysis (chapters 6 to 11), and \textit{Advanced} methods (chapters 12 to 15). Our graphical user interface (GUI) targets the second part. This can be download at \textbf{https://github.com/besmarter/BSTApp}. Instructors and students can have all codes, simulated and real data sets are also there. To install our GUI just type \textbf{shiny::runGitHub(``besmarter/BSTApp" , launch.browser=T)} in the \textbf{R} package console or any \textbf{R} code editor, and execute it.
