...
There are three ways to install our GUI. The simplest method, requiring only the installation of \textbf{R} and, optionally, an \textbf{R} code editor, is to install \textit{shiny} package, and then type:
