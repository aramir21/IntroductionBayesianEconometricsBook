...
\end{tcolorbox} 
	...
	\begin{itemize}
		\item Run Algorithm~A9 to report the results of the Geweke~\cite{Geweke1992}, Raftery~\cite{Raftery1992}, and Heidelberger~\cite{Heidelberger1983} tests using our GUI.
