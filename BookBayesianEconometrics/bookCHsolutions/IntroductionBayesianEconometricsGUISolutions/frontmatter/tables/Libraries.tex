\begin{table}[!ht]
	...
	\hline
	\multicolumn{4}{|c|}{\textbf{Time series models}} \\
	\hline  
	\multicolumn{1}{|c|}{\textbf{Model}} & \multicolumn{1}{c}{\textbf{Library}} & \multicolumn{1}{|c|}{\textbf{Command}} & \multicolumn{1}{|c|}{\textbf{Reference}} \\ 
	\hline
	Normal dynamic linear model & dlm& dlmGibbsDIGs & \cite{dlmPackage2010} \\
	\hline
	ARMA & bayesforecast & stan\_sarima & \cite{bayesforecast2020} \\
	\hline
	Stochastic volatility models & stochvol & svsample & \cite{hosszejni_kastner_2021} \\
	\hline
	VAR & bvartools & draw\_posterior & \cite{bvartools2024} \\
	\hline
	...
	Normal (Dynamic BMA) & dma & dma & \cite{dma2018} \\
