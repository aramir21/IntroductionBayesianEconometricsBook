...
2. Visit **[https://posit.cloud/content/10283833](https://posit.cloud/content/10283833)**, log in or sign up for **Posit Cloud**, navigate to the **BSTApp-master** folder in the **Files** tab of the right-bottom window, then click on the **app.R** file and select **Run App**.
