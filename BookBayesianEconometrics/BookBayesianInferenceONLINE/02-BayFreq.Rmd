...
## Why is the Bayesian approach not that popular? {#sec25}
...
1. **Jeffreys-Lindley paradox**
   ...
   The **Jeffreys-Lindley paradox** [@Jeffreys1961; @lindley1957statistical] represents an apparent disagreement between the Bayesian and Frequentist frameworks in a hypothesis testing scenario.
